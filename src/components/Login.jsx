    ...
    <div className="auth_auth_wrapper__Aq7dh border-4 rounded-lg h-auto">
      <div className="auth_auth_card_body__DM1Ob rtl_auth_card">
        <form>
          ...
          <p className="text-gray-600 text-start mx-4 mt-4">Please Login To Your Account To Continue.</p>
          ...
          <div className="mb-6 p-1  flex items-center justify-between ">
            <label className="mx-4 ">
              <input type="checkbox" className="form-checkbox text-xl " /> Remember Me
            </label>
            <a href="/forgot-password" className="text-lg mx-6 text-red-700">Forgot Password?</a>
          </div>
          <button type="submit" className="ap_btn ap_btn_full bg-red-800 p-4 px-7 text-xl font-semibold  rounded-lg"  onClick={handleClick}>Login</button>
          <div className="mt-4 mb-6 text-gray-600">Dont have an account? <a href="/registration" className="text-blue-500">Sign up!</a></div>
        </form>
      </div>
    </div>
  </div>
